...
export const sections = [
  ...
  },
  {
    id: 'pricing',
    title: 'Простые цены.',
    content: '3 дня бесплатно — без карты. Дальше один понятный тариф.',
    pricing: [
      {
        name: 'Пробный',
        price: '0₽',
        ...
        features: ['Все функции платформы', 'HTTPS + CDN', 'Preview-деплои для веток', 'Realtime логи', 'Без кредитной карты'],
        buttonText: 'Начать бесплатно',
      },
      {
        name: 'Pro',
        ...
        features: ['Всё из пробного', 'Безлимит проектов', 'Кастомные домены', 'Аналитика и алерты', 'Приоритетная поддержка'],
        highlighted: true,
        buttonText: 'Подключить Pro',
      },
    ]
  },
  {
